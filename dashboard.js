...
onAuthStateChanged(auth, (u) => {
  ...
  // === SAMAKAN DENGAN SISTEM LAMA ===
  user = u.email.startsWith("admin") ? "admin" : u.email;
  namaUser = u.email.split("@")[0]; // atau pakai displayName kalau ada
  role = user === "admin" ? "admin" : "sales";

  // ⬇️ SIMPAN AGAR KODE LAMA YANG PAKAI localStorage TETAP HIDUP
